                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-6">
                            ...
                            <div class="form-group mb-3 position-relative">
                                ...
                                <input type="text" class="form-control input-style" id="apellido" name="apellido"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group mb-3 position-relative" style="position: relative">
                                ...
                                <input class="form-control input-style" id="email" name="email" type="text"
                                    value="{{$usuario->email}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group mb-3 position-relative" style="position: relative">
                                ...
                                <input class="form-control input-style" type="tel" id="telefono" name="telefono"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group mb-3 position-relative" style="position: relative">
                                ...
                                <input type="text" class="form-control input-style" id="puesto" name="puesto"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group mb-3 position-relative" placeholder="Contraseña">
                                ...
                                <input type="password" class="form-control input-style" id="password" name="password"
                                    placeholder="****">
                            </div>
                        </div>
                    </div>
