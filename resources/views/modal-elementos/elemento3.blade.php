            ...
            <div class="col-12 ">
                ...
                <div class="accordion accordion-flush" id="accordionExample3">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="element7_one" class="accordion-collapse collapse show" aria-labelledby="element7_1" data-bs-parent="#accordionExample3">
                            <div class="accordion-body">
                                ...
                                <div id="iii-01" class="text-center" style="display: none;">
                                    ...
                                    <a href="{{route('pdf_iii_01.print')}}"><i class="icon_config fa fa-download" aria-hidden="true"></i></a>
                                </div>
                                ...
                                <div id="iii" class="text-center" style="display: none;">
                                    ...
                                    <a href="{{route('pdf_iii.print')}}"><i class="icon_config fa fa-download" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="element7_tree" class="accordion-collapse collapse " aria-labelledby="element7_2" data-bs-parent="#accordionExample3">
                            <div class="accordion-body">
                                <form action="index.php" method="post">
