                                    ...
                                    <div class="tab-pane fade show active" id="ejecutar" role="tabpanel"
                                        ...
                                        <div id="VIII-01-01" style="display: none;">
                                            ...
                                            <a class="btn text-dark"
                                                href="{{route('difundir_viii_01_01.index')}}"
                                                style="background-color:#001d3d;color:  yellow!important; border: 2px solid yellow!important;">
                                                Difundir
                                            </a>

                                            <a class="btn  " href="{{route('preventiva_viii_01_01.index')}}"
                                        ...
                                        <div id="VIII-01-02" style="display: none;">
                                            ...
                                            <a class="btn text-dark" href="{{route('difundir_viii_01_02.index')}}"
                                                style="background-color:#001d3d;color:  yellow!important; border: 2px solid yellow!important;">
                                                Difundir
                                            </a>

                                            <a class="btn  " href="{{route('preventiva_viii_01_02.index')}}"
                                                style="background-color:#001d3d;color:  red!important; border: 2px solid red!important;">
                                                Accion Correctiva
                                            </a>
                                        ...
                                        <div id="VIII-01-03" style="display: none;">
                                            ...
                                            <a class="btn text-dark" href="{{route('difundir_viii_01_03.index')}}"
                                                style="background-color:#001d3d;color:  yellow!important; border: 2px solid yellow!important;">
                                                Difundir
                                            </a>

                                            <a class="btn  " href="{{route('preventiva_viii_01_03.index')}}"
                                                style="background-color:#001d3d;color:  red!important; border: 2px solid red!important;">
                                                Accion Correctiva
                                            </a>
                                        </div>
                                        <div id="VIII-01-04" style="display: none;">
                                            ...
                                            <a class="btn text-dark" href="{{route('difundir_viii_01_04.index')}}"
                                                style="background-color:#001d3d;color:  yellow!important; border: 2px solid yellow!important;">
                                                Difundir
                                            </a>

                                            <a class="btn  " href="{{route('preventiva_viii_01_04.index')}}"
                                                style="background-color:#001d3d;color:  red!important; border: 2px solid red!important;">
                                                Accion Correctiva
                                            </a>
                                        </div>
                                        <div id="VIII-01-05" style="display: none;">
                                            ...
                                            <a class="btn text-dark" href="{{route('difundir_viii_01_05.index')}}"
                                                style="background-color:#001d3d;color:  yellow!important; border: 2px solid yellow!important;">
                                                Difundir
                                            </a>

                                            <a class="btn  " href="{{route('preventiva_viii_01_05.index')}}"
                                                style="background-color:#001d3d;color:  red!important; border: 2px solid red!important;">
                                                Accion Correctiva
                                            </a>
                                        </div>
