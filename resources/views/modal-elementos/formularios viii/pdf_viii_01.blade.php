...
@section('content_pdf')
            <div class="col-12 ">
               ...
               <strong> 1.- OBJETIVO</strong><br><br>
                ...
                3.1.- Elaboración de documentación.<br>
                ...
                elaboró, quién revisó y quién aprobó <br>
                 Cuando es necesario, se introducen anexos al final del procedimiento.
            ...
            <div class="col-12 ">
                <p class="p-5">
                    ...
                    (SGM) son aplicables a los requisitos de la Ley Norma Modelo. <br>
                    ...
                    revisada y posterior, se realizarán las correcciones solicitadas.<br>
                   ...
                   <strong> 3.3. Distribución de documentación.</strong><br><br>
                    ...
                    - Fecha<br>
                    - Archivo digital que puede ser descargado por el usuario para su visualización y consulta
            ...
            <div class="col-12 ">
                <p class="p-5">
                    ...
                    El listado anterior, permitirá consultar el historial de los permisos y las autorizaciones. <br><br>
            ...
            <div class="col-12 ">
                <p class="p-5">
                    ...
                    permisos cargando los siguientes campos: <br> <br>
