    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalXIV">Crear XIV-01-01</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="POST" action="{{ route('store.xiv_01_01') }}" enctype="multipart/form-data" role="form">
                @csrf
                <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-6 mt-3">
                                    ...
                                    <input name="nombre_unidad" type="text" class="form-control" id="nombre_unidad">
                                </div>

                                <div class="form-group col-6 mt-3">
                                    <label>Número de autorización</label>
                                    <input name="numero_autorizacion" type="text" class="form-control" id="numero_autorizacion">
                                </div>
                                ...
                                <div class="form-group col-6 mt-3">
                                    ...
                                    <input name="vigencia" type="date" class="form-control" id="vigencia">
                                </div>
