    ...
    <body style="background-color:#ffffff!important">
        ...
        <div class="col-12">
            ...
            <p>
                ...
                Domicilio para oír y recibir notificaciones: <strong>PARCELA 16-Z-1 P1/1 CARRETERA ESTATAL HOMUNCUZAMA EJIDO
                    NOHCHAKAN, CUZAMA</strong><br>
            </p>
            <p>
                <br>
            ...
            <ul>
                ...
                <li type="disc">Asegurar que el Sistema de Administración es conforme con los requisitos establecidos en los
                    lineamientos de ASEA y demás normativa aplicable.</li>
                <li type="disc">Informar a la Alta Dirección del Regulado acerca del desempeño del Sistema de
                    Administración.</li>
                <li type="disc">Proponer la adopción de medidas para aplicar las mejores prácticas con código IX.</li>
                <li type="disc"> Dar aviso a la Agencia de cualquier riesgo o riesgo crítico que pueda comprometer la
                    Seguridad Industrial, la Seguridad Operativa o el Medio Ambiente.</li>
                <li type="disc">Coordinar y apoyar al resto de las áreas en la definición e implementación de las acciones
                    necesarias para subsanar los incumplimientos de los requisitos del SA.</li>
                <li type="disc"> Coordinar los trabajos internos para subsanar las irregularidades o incumplimientos de la
                    normatividad externa e interna aplicable, establecida en la matriz de requisitos legales.</li>
            </ul>
            </p>
            <p>
                <br><br>
            ...
            <ul>
                ...
                <li type="disc">Elaborar los reportes e información sobre el SGM requerida por la Comisión o por la Empresa
                    especializada que los solicite como parte de una visita de verificación.</li>
                <li type="disc">Conservar la documentación relativa al SGM para su consulta por la Comisión cuando ésta lo
                    requiera o para consulta de otros Permisionarios, o usuarios del sistema de almacenamiento permisionado
                    por un periodo mínimo de 10 años</li>
                <li type="disc">Generar, organizar, implementar cambios, difundir, almacenar y dar trazabilidad a toda la
                    información derivada de la operación del SGS.</li>
            </ul>
            </p>
