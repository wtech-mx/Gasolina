                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        <div class="d-flex justify-content-between p-3">
                            ...
                            <h5 class="text-white">PLAN Y PROGRAMA DE AUDITORÍA EXTERNA</h5>
                    ...
                    @include('modal-elementos.formularios xv.xv-01-02.create')
                    <div class="col-12 p-4">
                        <table class="table" id="table_id">
                            ...
                            <tbody class="text-white">
                                ...
                                @include('modal-elementos.formularios xv.xv-01-02.update')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
