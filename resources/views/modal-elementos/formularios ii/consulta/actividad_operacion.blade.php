        ...
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <div class="d-flex justify-content-between p-3">
                    ...
                    <h5 class="text-white">II-02-01 FASE DEL PROYECTO::OPERACIONAL</h5>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-valorizacion" role="tabpanel" aria-labelledby="pills-valorizacion-tab">
                    <div class="col-12 p-4">
                        @include('modal-elementos.formularios ii.consulta.tabla_valori_operacion')
                    </div>
                </div>

                <div class="tab-pane fade" id="pills-operacional" role="tabpanel" aria-labelledby="pills-operacional-tab">
                    @include('modal-elementos.formularios ii.consulta.tabla_control_operacion')
                </div>

                <div class="tab-pane fade" id="pills-aplicable" role="tabpanel" aria-labelledby="pills-aplicable-tab">
                    @include('modal-elementos.formularios ii.consulta.tabla_norma_operacion')
                </div>
            </div>
        </div>
    </div>
