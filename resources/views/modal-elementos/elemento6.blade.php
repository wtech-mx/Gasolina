      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="col-12 ">
                ...
                <div class="accordion accordion-flush" id="element_6">
                  <div class="accordion-item">
                    <h2 class="accordion-header" >
                      <button class="accordion-button btn-grid" type="button" data-bs-toggle="collapse" data-bs-target="#element_6collapse" aria-expanded="true" aria-controls="element_6collapse">
                          III-01-01
                      </button>
                    </h2>
                    <div id="element_6collapse" class="accordion-collapse collapse show" aria-labelledby="element1" data-bs-parent="#element_6">
                      <div class="accordion-body">
                            <h5 class="text-center" style="font-size: 15px">Matriz de requisitos legales.</h5>
                            {{--nav tittle arrow--}}
