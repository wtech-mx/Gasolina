              ...
              <ul class="nav nav-pills d-flex justify-content-center mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item p-2" role="presentation">
                  <a class="nav-link a-perso active show" id="users-registers" data-bs-toggle="pill" data-bs-target="#pills-tanque" type="button" role="tab" aria-controls="pills-tanque" aria-selected="true">
                       <i class="fa fa-user icon-style-2 p-1 "></i>Tanque
                  </a>
                </li>

                <li class="nav-item p-2" role="presentation">
                  <a class="nav-link a-perso" id="register-passwords" data-bs-toggle="pill" data-bs-target="#pills-medicion" type="button" role="tab" aria-controls="pills-medicion" aria-selected="false">
