<h2 class="text-left mb-3" style="color: #FFC300!important">Mis actividades</h2>
...
<div class="card card-menu">
    <div class="card-body">
        ...
        <h4 class="card-title card-menu-title">Semanales</h4>
    </div>
</div>
...
<div class="card card-menu">
    <div class="card-body">
        ...
        <h4 class="card-title card-menu-title">Mensuales</h4>
    </div>
</div>
